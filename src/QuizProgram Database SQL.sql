...
/*
 * Default quiz for Basic Math: 20 questions on addition, subtraction, multiplication, division, and powers.
 */
INSERT INTO quiz(quizName, subject, quizKey, totalQuestions, timeLimit, teacherId, practice) 
	VALUES('Default: Basic Math', 'Basic Math', 'default0', 10, 3000, -1, 1);
...
/*
 * Default quiz for Algebra: 10 basic algebra questions
 */
INSERT INTO quiz(quizName, subject, quizKey, totalQuestions, timeLimit, teacherId, practice)
	VALUES('Default: Algebra', 'Algebra', 'default1', 10, 3000, -1, 1);
INSERT INTO question(question, option1, option2, option3, option4, correctIndex, help) 
...
/*
 * Default quiz for Science: 10 basic science questions
 */
INSERT INTO quiz(quizName, subject, quizKey, totalQuestions, timeLimit, teacherId, practice)
	VALUES('Default: Science', 'Science', 'default1', 10, 3000, -1, 1);
INSERT INTO question(question, option1, option2, option3, option4, correctIndex, help) 
